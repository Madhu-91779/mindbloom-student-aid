...
const Navigation = ({ activeTab, onTabChange }: NavigationProps) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-lg border-t border-border/50 shadow-wellness z-50">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && <div className="w-6 h-1 bg-gradient-to-r from-primary to-accent rounded-full" />}
            </button>
          );
        })}
      </div>
